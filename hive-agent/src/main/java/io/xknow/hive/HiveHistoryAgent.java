...
//        try {
//            LOG.info("Redfine class HiveHistoryImpl.class by class file " + classFile);
...
//        }
        ...
        inst.addTransformer(new ClassTransformer("org/apache/hadoop/hive/ql/history/HiveHistoryImpl", classFile));
    }
}
